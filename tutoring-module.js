...
const TutoringModule = (() => {
  ...
  const getLearnerData = () => {
    try {
      ...
      const userData = localStorage.getItem('douanelmsv2');
      ...
      log(`Erreur récupération données apprenant: ${error.message}`);
  ...
  const sendEmail = async (email) => {
    try {
      ...
      const TUTORING_EMAIL = 'patrick.carreira@test.test// Test 2: Appeler getlearnerData()
const learnerData = TutoringModule.getLearnerData();
console.log('Learner Data:', learnerData);
VM1698:1 TutoringModule: object
tutoring-module.js:75 22:59:20 [TutoringModule] [TutoringModule] userData structure:
tutoring-module.js:75 22:59:20 [TutoringModule] [TutoringModule] userData.user:
tutoring-module.js:75 22:59:20 [TutoringModule] [TutoringModule] userData.profil:
tutoring-module.js:75 22:59:20 [TutoringModule] [TutoringModule] Données apprenant extraites:
VM1698:5 Learner Data: {fullName: 'Non renseigné', firstName: 'Non renseigné', lastName: 'Non renseigné', matricule: 'knme', email: 'Non renseigné'}
undefined
console.log('TutoringModule:', typeof TutoringModule);
VM1702:1 TutoringModule: object
undefined.ch';
      ...
      const bodyLines = [
        ...
        '',
        '👤 DONNÉES APPRENANT:',
        `   Nom complet: ${learnerData.fullName}`,
